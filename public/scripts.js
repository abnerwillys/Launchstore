...
const Validate = {
  apply(input, funcName) {
    ...
    let results = Validate[funcName](input.value)
  ...
  displayError(input, error) {
    ...
    const divFather = input.parentNode
    divFather.classList.add('with-error')
  ...
  clearErrors(input) {
    ...
    const errorDiv = divPai.querySelector('.error')

    if (errorDiv) {
      divPai.classList.remove('with-error')
      errorDiv.remove()
    }
